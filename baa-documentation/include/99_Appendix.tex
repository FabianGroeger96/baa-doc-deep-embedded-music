...
\begin{table}[htbp]
    ...
    \begin{tabular}{l|l|l|l|l}
        ...
        \midrule[1pt]
        Input pipeline DCASE triplet selection & get triplets & passed & get valid triplets & got valid triplets \\
        \bottomrule
    \end{tabular}
\end{table}
...
\includepdf[scale=0.9, pages=1-]{baa-study-doc/experiment_margin/Study_Doc_Margin.pdf}
