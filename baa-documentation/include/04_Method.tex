...
\centering
    ...
    \ganttbar[progress=30,inline=false]{Default Architecture}{6}{6} \\
    \ganttbar[progress=50,inline=false]{Evaluation Workflow}{6}{6} \\
    \ganttbar[progress=0,inline=false]{Unit tests}{6}{6} \\
    \ganttmilestone[inline=false]{Project Setup finished}{6} \\ % M2
    \ganttbar[progress=70,inline=false]{Tile2Vec implementation}{7}{7} \\
