...
\centering
    ...
    \ganttbar[progress=90,inline=false]{Default Architecture}{6}{6} \\
    \ganttbar[progress=60,inline=false]{Evaluation Workflow}{6}{6} \\
    \ganttbar[progress=10,inline=false]{Unit tests}{6}{6} \\
