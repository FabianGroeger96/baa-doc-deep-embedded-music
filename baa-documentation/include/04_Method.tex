...
\begin{table}[htbp]
    ...
    \begin{tabular}{p{.70\textwidth} | p{.20\textwidth}}
        ...
        \midrule[1pt]
        Research finished & 19.02.2020\\
        \hline
        Project setup finished & 19.02.2020\\
        \hline
        Realization finished & 19.02.2020\\
        \hline
        Experiments finished & 19.02.2020\\
        \hline
        Thesis submission & 19.02.2020\\
        \bottomrule
    \end{tabular}
\end{table}
...
\centering
    ...
    \ganttbar[progress=50,inline=false]{Triplet Loss}{2}{2}\\
