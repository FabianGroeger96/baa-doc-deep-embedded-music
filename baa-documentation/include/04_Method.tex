...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[start chain=going below, node distance=15pt,
        ...
        \node[fc] {Dense layer (hidden layer 1): \\ 256 units, ReLU};
        \node[fc] {Dense layer (hidden layer 2): \\ 256 units, ReLU};
        \node[softmax] {Dense output: \\ 9 units (num. of classes), softmax};
        \node[point] {Output};
    \end{tikzpicture}
