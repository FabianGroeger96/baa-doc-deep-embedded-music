...
\begin{figure}[htbp]
	...
	\caption{UML diagram of the \texttt{feature extractor} directory}
...
\label{listing:Extractor-Factory}
\end{listing}
\noindent
...
\label{listing:Model-Factory-Creating}
\end{listing}
\noindent
...
\label{listing:Parse-Params-File}
\end{listing}
\noindent
...
\label{listing:Create-Dataset-Extractor}
\end{listing}
\noindent
...
\label{listing:Embedding-Model-Optimizer-Pipeline}
\end{listing}
\noindent
...
\label{listing:Save-Restore-Embedding-Model}
\end{listing}
\noindent
...
\label{listing:Epoch-Loop-Embedding-Model}
\end{listing}
\noindent
...
\label{listing:Batch-Loop-Embedding-Model}
\end{listing}
\noindent
...
\label{listing:Visualising-Embedding-Model}
\end{listing}
\noindent
...
\label{listing:Classifier-Model-Creation}
\end{listing}
\noindent
...
\label{listing:Classifier-Loss-Optimizer}
\end{listing}
\noindent
...
\label{listing:Save-Embeddings}
\end{listing}
\noindent
Then the embeddings also have to be saved to a checkpoint file which the projector of the Tensorboard will load directly. This can be done by passing the embeddings converted to a tensor to a \texttt{Saver} and saving it as a \texttt{.ckpt} file, which is shown in listing \ref{listing:Save-Embeddings-Ckpt}.
...
\label{listing:Save-Embeddings-Ckpt}
\end{listing}
\noindent
As the last step the created embeddings have to be registered with the projector, which is done using the \texttt{tensorboard.plugins.projector} plugin, by providing the name of the embedding tensor and the label metadata file. The listing \ref{listing:Register-Embeddings} shows the process in more detail.
...
\label{listing:Register-Embeddings}
\end{listing}
\noindent
