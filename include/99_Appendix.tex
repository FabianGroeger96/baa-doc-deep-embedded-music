...
\includepdf[scale=0.9, pages=1-]{study-doc/experiment_margin/Study_Doc_Margin.pdf}

\includepdf[scale=0.9, pages=1-]{study-doc/experiment_tile_size/Study_Doc_tile_size.pdf}
